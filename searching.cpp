...
// Given a sorted array and a sum , find if there is a triple pair with given sum
// [O(n^2)] --> sorted array
// #include <iostream>
// using namespace std;

// int Two_pair(int arr[], int low ,int high, int item)
// {
//     while (low < high)
//     {
//         if (arr[low] + arr[high] == item)
//             return 1;
//         else if (arr[low] + arr[high] > item)
//             high--;
//         else
//             low++;
//     }
...
//     for(int i=0;i<n;i++)
//     {
//     if(Two_pair(arr, i+1,n-1, item-arr[i]))
//          cout<<"true"<<" ";
//     }
//     return 0;
// }
...
//     int arr[n];
//     cout<<"Enter the array elements(value should be less than n ";
//     for(int i=0;i<n;i++)
//     {
//         cin>>arr[i];
//     }
//      int res = repeating(arr,n);
//      cout<< "repeated element is -> " << res ;
//     return 0;
// }